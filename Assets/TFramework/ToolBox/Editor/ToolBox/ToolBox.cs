...
namespace TFramework.ToolBox
{
    public abstract class BaseToolBox : VisualElement
    {
        ...
        /// 提示文本
        /// </summary>
        public virtual int PreLoadIndex => PlayerPrefs.GetInt(TabName,BasePreLoadIndex);
    ...
    public partial class ToolBox : VisualElement
    {
        ...
        public Tab AddTab(BaseToolBox element, string tabName = "", bool closeable = true)
        {
            ...
            tab.Add(element);
            tab.tabHeader.RegisterCallback(new EventCallback<PointerDownEvent>(_ =>
            {
                var index = tab.tabHeader.parent.IndexOf(tab.tabHeader);
                PlayerPrefs.SetInt(element.TabName,index);
            }));
            m_TabView.Add(tab);
            return tab;
        }
        ...
        private void ReLoadAllTabs()
        {
            ...
            foreach (var toolBox in boxList)
            {
                ...
                PlayerPrefs.SetInt(toolBox.TabName,toolBox.PreLoadIndex);
